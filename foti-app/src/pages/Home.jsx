...
//import { useNavigate } from 'react-router-dom';
// Importing React Icons for Social Media (optional)
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow">
        ...
        {/* About Us Section */}
        <section id="about" className="mt-12 p-8">
        ...
        {/* Programs Section */}
        <section id="programs" className="mt-12 p-4">
        ...
        {/* Why FoTI Section */}
        <section id="why-foti" className="mt-12 p-8">
        ...
        <section id="tour-packages" className="mt-12 p-8">
